...
//
const BotName = 'SLANDER BOT'; // Nama Bot Whatsapp
const instagramlu = 'SlanderBOT Gak Punya IG'; // Nama Instagramlu cok
const whatsapplu = 'wa.me/+62881023975125'; // Nomor whatsapplu cok
const kapanbotaktif = 'Tergantung Jaringan'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/DJJWdJa2Tsp1BVOvtvxbIo'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/FmcBYw2N72J3ukA2dVUwPS'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Scan kode qr mu Bambang!!`);
});
